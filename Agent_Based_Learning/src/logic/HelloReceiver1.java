...
public class HelloReceiver1 extends Thread{
     public String name;
     public String dist;
     public String rang;
     int nop,length;
     ...
     public int minvalue;
     public int maxvalue;
     public HelloReceiver1(String name){
     this.name=name;
     ...
     while(true){
                ...
                if(set.equalsIgnoreCase("MobileDetails1")){
                         ...
                         if(!(name.equals(nname))){
                           ...
                           {       // System.out.println("Gate------->"+nname);
                             ...
                             String dispneiname11 = new String();
                                             ...
                                             System.out.println("-----admin----"+dispneiname11);
                             }
                                             //System.out.println("gate****--->"+dispneiname11);
                                            valueobject.setneigh2(dispneiname11);
